...
export class EmergencyReportsController {
  public constructor(private readonly emergencyReportsService: EmergencyReportsService) {}

  @Post()
  async CreateEmergencyReport(@Body()  emergencyReports: Record<string,any>): Promise<any>
  {
    try{
      const emergencyReports_obj: EmergencyReports = plainToInstance(EmergencyReports, emergencyReports);
      return await this.emergencyReportsService.CreateEmergencyReport(emergencyReports_obj);
  ...
  async GetAllEmergencyReports(): Promise<any> {
    const emergencyReports: EmergencyReports[] = await this.emergencyReportsService
  ...
  @Patch()
  async UpdateEmergencyReport(@Body() updateEmergencyReports: Record<string,any>): Promise<any>
  {
    try{
    const emergencyReports_obj: UpdateEmergencyReports = plainToInstance(UpdateEmergencyReports, updateEmergencyReports);
    const operation: UpdateEmergencyReports = await this.emergencyReportsService
      .UpdateEmergencyReport(emergencyReports_obj);

    return "EmergencyReports actualizado correctamente: " + JSON.stringify(operation);
    }catch(error){
